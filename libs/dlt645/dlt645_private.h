...
#define DL645_PREMBLE_LEN 4 //前导码长度
...
//645 调用底层接口接收数据
extern int dlt645_receive_msg(dlt645_t* ctx, uint8_t* msg, uint16_t len, uint32_t code, dlt645_protocal protocal, int timeout_ms);
//645 调用底层接口发送
