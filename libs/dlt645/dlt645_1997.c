 ...
 */
int dlt645_1997_read_data(dlt645_t *ctx, uint32_t code, uint8_t *read_data, int timeout_ms)
{
    ...
    if (dlt645_receive_msg(ctx, read_buf, DL645_RESP_LEN, code, DLT645_1997, timeout_ms) < 0)
    {
