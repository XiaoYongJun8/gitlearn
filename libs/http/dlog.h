...
static void __attribute__((unused))logmsg(char* file, int line, int logLevel, char* fmt, ...)
{
    va_list ap;
    char buf[1024] = {0};
...
#include "log.h"
#define dtrace(fmt, args...)	log_write(g_plog, LOG_LV_TRACE, LOG_FLAG, fmt, ##args)
